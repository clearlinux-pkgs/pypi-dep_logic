...
Version  : 0.3.3
Release  : 7
URL      : https://files.pythonhosted.org/packages/a3/73/cfc95cff9af7736ed89804940d7cc8d7ca4a6862b8f87b72981a978e6c83/dep_logic-0.3.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/a3/73/cfc95cff9af7736ed89804940d7cc8d7ca4a6862b8f87b72981a978e6c83/dep_logic-0.3.3.tar.gz
...
%prep
%setup -q -n dep_logic-0.3.3
cd %{_builddir}/dep_logic-0.3.3
pushd ..
cp -a dep_logic-0.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719946356
