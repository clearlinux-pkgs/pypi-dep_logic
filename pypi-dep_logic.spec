...
Source0  : https://files.pythonhosted.org/packages/46/c6/810b34258a5f4be719a74f011e4b6a3bf4fd1fe38a400fe2682f3d87576f/dep_logic-0.4.9.tar.gz
...
%prep
%setup -q -n dep_logic-0.4.9
cd %{_builddir}/dep_logic-0.4.9
pushd ..
cp -a dep_logic-0.4.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727101311
