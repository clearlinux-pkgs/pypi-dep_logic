...
Source0  : https://files.pythonhosted.org/packages/fa/d8/11db71e3b8961152a777258cf627f9fe9bacce7ec2f2e07d2e8c6ad0cd90/dep_logic-0.4.11.tar.gz
...
%prep
%setup -q -n dep_logic-0.4.11
cd %{_builddir}/dep_logic-0.4.11
pushd ..
cp -a dep_logic-0.4.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740495090
