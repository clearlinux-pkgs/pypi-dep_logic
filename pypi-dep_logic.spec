...
Source0  : https://files.pythonhosted.org/packages/4d/f8/42361c2360a1dcf3a2cca0779fc2fe678077812076de4aefe806ddae5ede/dep_logic-0.5.1.tar.gz
...
%prep
%setup -q -n dep_logic-0.5.1
cd %{_builddir}/dep_logic-0.5.1
pushd ..
cp -a dep_logic-0.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747666425
