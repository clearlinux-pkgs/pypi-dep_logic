...
Source0  : https://files.pythonhosted.org/packages/ab/c5/afb10abeb1ee2b096f3b88b0d83808f482cdae6347b8ea36aeb9126c34d8/dep_logic-0.4.2.tar.gz
...
%prep
%setup -q -n dep_logic-0.4.2
cd %{_builddir}/dep_logic-0.4.2
pushd ..
cp -a dep_logic-0.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721061073
