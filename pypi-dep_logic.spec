...
Version  : 0.3.0
Release  : 6
URL      : https://files.pythonhosted.org/packages/3a/08/b12c393c05996c9c1f33d39f069755d870a95f85beb18670f196b0c0b94a/dep_logic-0.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/3a/08/b12c393c05996c9c1f33d39f069755d870a95f85beb18670f196b0c0b94a/dep_logic-0.3.0.tar.gz
...
%prep
%setup -q -n dep_logic-0.3.0
cd %{_builddir}/dep_logic-0.3.0
pushd ..
cp -a dep_logic-0.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719591788
