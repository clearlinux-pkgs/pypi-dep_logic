...
Source0  : https://files.pythonhosted.org/packages/dc/75/a87a3f38ba5db338140fda00e586d243ef8cef132af051fe0572b023996f/dep_logic-0.4.10.tar.gz
...
%prep
%setup -q -n dep_logic-0.4.10
cd %{_builddir}/dep_logic-0.4.10
pushd ..
cp -a dep_logic-0.4.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735095101
