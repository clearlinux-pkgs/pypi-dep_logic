...
Source0  : https://files.pythonhosted.org/packages/02/c8/f2d9d1e5ed8c4d37ed898ea4cdf20bed829d351fbf3426e815b68db3fa51/dep_logic-0.5.0.tar.gz
...
%prep
%setup -q -n dep_logic-0.5.0
cd %{_builddir}/dep_logic-0.5.0
pushd ..
cp -a dep_logic-0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744724301
