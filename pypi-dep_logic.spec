...
Source0  : https://files.pythonhosted.org/packages/61/fc/a9f6af758c26a22fbc104285b73134d24702bbd2e646dcf7c7fa6d4466af/dep_logic-0.4.5.tar.gz
...
%prep
%setup -q -n dep_logic-0.4.5
cd %{_builddir}/dep_logic-0.4.5
pushd ..
cp -a dep_logic-0.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725461109
